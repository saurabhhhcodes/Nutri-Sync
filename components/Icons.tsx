...
export const NutriSyncLogo: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <path d="M12 21C12 21 15 21 17 14L22 26C24 20 28 20 28 20" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" filter="url(#glow)" />
    <circle cx="20" cy="20" r="14" stroke="white" strokeWidth="1" strokeOpacity="0.2" />
  </svg>
);
...
export const PayPalIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M7.076 21.337H9.13l.907-5.746h2.411c2.472 0 4.385-1.004 4.908-4.31.252-1.58-.04-2.734-.877-3.456-.78-.675-1.956-1.005-3.486-1.005H7.727L5.674 21.337h1.402z" fill="#003087"/>
    <path d="M7.727 6.82h5.267c1.53 0 2.706.33 3.486 1.005.837.722 1.129 1.876.877 3.456-.523 3.306-2.436 4.31-4.908 4.31H9.13L7.727 6.82z" fill="#009CDE"/>
  </svg>
);
...
export const AxonFlowIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const GoogleIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g transform="matrix(1, 0, 0, 1, 27.009001, -39.238998)">
      ...
      <path fill="#FBBC05" d="M -21.484 53.529 C -21.734 52.809 -21.864 52.039 -21.864 51.239 C -21.864 50.439 -21.734 49.669 -21.484 48.949 L -21.484 45.859 L -21.484 45.859 C -26.284 47.489 -26.754 49.299 -26.754 51.239 C -26.754 53.179 -26.284 54.989 -25.464 56.619 L -21.484 53.529 Z" />
